...
public class GoodsShouyinView extends GoodsShouyinEntity implements Serializable {
	...
	public GoodsShouyinView(GoodsShouyinEntity goodsShouyinEntity) {
		try {
			BeanUtils.copyProperties(this, goodsShouyinEntity);
